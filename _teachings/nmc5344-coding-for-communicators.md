...
time: TBD
code: NMC5344
course_id: coding-for-communicators
schedule:
  - week: 7
    date: "Week 7"
    topic: "R Foundations and Data Visualization"
    description: "Morning: course introduction and R/RStudio fundamentals. Afternoon: data visualization fundamentals."
  - week: 8
    date: "Week 8"
    topic: "Tidy Data and Exploratory Visualization"
    description: "Morning: tidy data and data transformation. Afternoon: exploratory data visualization."
  - week: 9
    date: "Week 9"
    topic: "Data Wrangling and Project Proposals"
    description: "Morning: data import, cleaning, joining, and reshaping. Afternoon: group project proposal presentations."
  - week: 10
    date: "Week 10"
    topic: "Functions, Iteration, and Web Scraping"
    description: "Morning: functions and iteration. Afternoon: web scraping and responsible data collection."
  - week: 11
    date: "Week 11"
    topic: "Introductory Models and Reproducible Reporting"
    description: "Morning: fitting and interpreting introductory models. Afternoon: reproducible reporting with R Markdown and GitHub."
  - week: 12
    date: "Week 12"
    topic: "Final Quiz and Course Wrap-Up"
    description: "Morning: final quiz. Afternoon: course wrap-up and project reflection."
---
...
- Grolemund, G., & Wickham, H. (2017). [_R for Data Science_](https://r4ds.had.co.nz/). O'Reilly Media.
- Wickham, H., Çetinkaya-Rundel, M., & Grolemund, G. (2023). [_R for Data Science_ (2nd ed.)](https://r4ds.hadley.nz/). O'Reilly Media.
